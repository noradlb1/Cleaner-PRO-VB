...
Namespace Cleaner_PRO
	Partial Public Class White1
		...
		End Function
		Private Sub White1_MouseDown(ByVal sender As Object, ByVal e As MouseEventArgs) Handles MyBase.MouseDown
		...
		Private Sub bunifuDropdown1_onItemSelected(ByVal sender As Object, ByVal e As EventArgs) Handles bunifuDropdown1.onItemSelected
			...
			Progressbar2.Text = Progressbar2.Value.ToString() & "%"
		End Sub
		Private Sub circularProgressBar1_Click(ByVal sender As Object, ByVal e As EventArgs)
...
'INSTANT VB NOTE: The variable handle was renamed since Visual Basic does not handle local variables named the same as class members well:
		...
		Private Sub notifyIcon1_MouseDoubleClick(ByVal sender As Object, ByVal e As MouseEventArgs) Handles notifyIcon1.MouseDoubleClick
			...
			notifyIcon1.Visible = False
		End Sub
		Private Sub White1_FormClosing(ByVal sender As Object, ByVal e As FormClosingEventArgs)

		End Sub
		Private Sub White1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
		...
		Private Sub bunifuThinButton24_Click_1(ByVal sender As Object, ByVal e As EventArgs) Handles bunifuThinButton24.Click
