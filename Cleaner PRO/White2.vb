...
Namespace Cleaner_PRO
	Partial Public Class White2
		...
		End Function
		Private Sub White2_FormClosing(ByVal sender As Object, ByVal e As FormClosingEventArgs)

		End Sub
		Private Sub White2_MouseDown(ByVal sender As Object, ByVal e As MouseEventArgs) Handles MyBase.MouseDown
...
'INSTANT VB NOTE: The variable name was renamed since Visual Basic does not allow variables and other class members to have the same name:
		...
		Private Sub White2_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
		...
		Private Sub bunifuDropdown1_onItemSelected(ByVal sender As Object, ByVal e As EventArgs)
			Dim s As String = bunifuDropdown1.selectedValue.ToString()
...
'INSTANT VB NOTE: The variable is64Bit was renamed since Visual Basic does not handle local variables named the same as class members well:
		...
		Private Sub bunifuThinButton23_Click_1(ByVal sender As Object, ByVal e As EventArgs) Handles bunifuThinButton23.Click
